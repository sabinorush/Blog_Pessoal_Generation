...
public class UsuarioControllerTest {
	...
	public void deveCriarUmUsuario() {
		...
		/* Define e cria requisição que você quer fazer */
		HttpEntity<Usuario> requisicao = new HttpEntity<Usuario>(
				new Usuario(0L, "Paulo Antunes", "paulo_antunes@email.com.br", "13465278"));

		/* Envia a requisição usando o testRestTemplate atraves do metodo exchange */
		ResponseEntity<Usuario> resposta = testRestTemplate.exchange("/usuarios/cadastrar", HttpMethod.POST, requisicao,
				Usuario.class);

		/* Verifica se a resposta da requisição enviada é a mesma que você enviou */
	...
	@Test
	@Order(2)
	@DisplayName("Não deve permitir duplicar usuário")
	...
	public void deveAtualizarUmUsuario() {
		...
		Optional<Usuario> usuarioCreate = usuarioService.cadastrarUsuario(new Usuario(0L, 
			"Gustavo Sabrino", "gu.sabino@hotmail.com", "Gustavo@123"));

		Usuario usuarioUpdate = new Usuario(usuarioCreate.get().getId(), 
			"Gustavo Araujo Sabino", "gu.sabino@hotmail.com", "Gustavo@123");
